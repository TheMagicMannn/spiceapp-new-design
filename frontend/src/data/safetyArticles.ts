// Safety Articles Content
import { ArticleContent } from './articleContent';

export const safetyArticles: ArticleContent[] = [
  // Online Safety
  {
    ...
    tags: ["privacy", "online safety", "dating apps", "security"],
    content: `
...
Stay safe out there.
  ...
  },
  {
    ...
    tags: ["catfishing", "fake profiles", "verification", "safety"],
    content: `
...
Stay safe, and don't let the fakes discourage you from finding real connections.
  ...
  },
  {
    ...
    tags: ["communication", "security", "encryption", "privacy"],
    content: `
...
Your privacy is worth protecting. Take the time to do it right.
  ...
  // Dating Safety
  {
    ...
    tags: ["safety", "first meet", "dating", "checklist"],
    content: `
## Meeting Someone New
...
Stay safe, and enjoy the connections!
  ...
  },
  {
    ...
    tags: ["safety", "buddy system", "friends", "support"],
    content: `
## The Buddy System
...
Be safe. Have fun. And be a good buddy to others when they need it.
  ...
  },
  {
    ...
    tags: ["instincts", "red flags", "safety", "intuition"],
    content: `
## Your Gut Knows
...
Trust yourself. Your instincts are there for a reason.
  ...
  // Consent & Boundaries
  {
    ...
    tags: ["consent", "boundaries", "communication", "safety"],
    content: `
## Beyond "No Means No"
...
Enthusiastic consent: because "yes" should mean "hell yes."
  ...
  },
  {
    ...
    tags: ["boundaries", "communication", "consent", "relationships"],
    content: `
...
Your boundaries are valid. Communicate them clearly. Enforce them consistently. And extend the same respect to others.
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1531746790095-e650311da693?w=600&h=400&fit=crop",
    author: "SPICE Team",
    readTime: "8 min read",
    publishedDate: "2025-01-01",
    tags: ["consent", "safety", "resources", "support"],
    content: `
## When Consent Is Violated
...
Reach out for help. You deserve support.
  ...
  // Sexual Health
  {
    ...
    tags: ["STI", "testing", "health", "safety"],
    content: `
...
Stay healthy, play safe.
  ...
  },
  {
    ...
    tags: ["safer sex", "barriers", "ENM", "health"],
    content: `
## Safer Sex in ENM
...
Play safe. Play often. Take care of each other.
  ...
  },
  {
    ...
    tags: ["PrEP", "PEP", "HIV prevention", "sexual health"],
    content: `
...
export function getSafetyArticleBySlug(slug: string): ArticleContent | undefined {
  return safetyArticles.find(article => article.slug === slug);
}

export function getSafetyArticlesByCategory(category: string): ArticleContent[] {
  return safetyArticles.filter(article => article.category === category);
}
