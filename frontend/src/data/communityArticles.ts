// Community & Lifestyles Articles Content
import { ArticleContent } from './articleContent';

export const communityArticles: ArticleContent[] = [
  // ENM Articles
  {
    ...
    tags: ["ENM", "introduction", "relationship structures"],
    content: `
...
Welcome to exploring your options.
  ...
  },
  {
    ...
    tags: ["ENM", "cheating", "consent", "ethics"],
    content: `
...
Cheating is defined by deception. ENM is defined by communication. They're opposites, not variations.
  ...
  },
  {
    ...
    tags: ["coming out", "family", "friends", "ENM"],
    content: `
...
Your relationship structure is valid. You deserve to be seen and accepted for who you are.
  ...
  // BDSM Articles
  {
    ...
    tags: ["BDSM", "kink", "introduction", "basics"],
    content: `
## What is BDSM?
...
Welcome to your exploration.
  ...
  },
  {
    ...
    tags: ["aftercare", "BDSM", "wellbeing", "safety"],
    content: `
## What is Aftercare?
...
Negotiate it, practice it, receive it. Your scenes and relationships will be better for it.
  ...
  },
  {
    ...
    tags: ["kink identity", "exploration", "BDSM", "self-discovery"],
    content: `
## Your Kink Journey
...
export function getCommunityArticleBySlug(slug: string): ArticleContent | undefined {
  return communityArticles.find(article => article.slug === slug);
}

export function getCommunityArticlesByCategory(category: string): ArticleContent[] {
  return communityArticles.filter(article => article.category === category);
}
